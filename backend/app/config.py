...
if not _database_url:
    raise RuntimeError(
        "DATABASE_URL is required. Configure Render (or your host) with the PostgreSQL "
        "connection string; local SQLite fallback is disabled because the filesystem is ephemeral."
    )
