...
# Extract Pango block (lines 16 to 55)
pango_lines = lines[15:56]
new_lines = [l for l in new_lines if l not in pango_lines]

# Also remove _PLACEHOLDER_BY_ROLE
placeholder_start = -1
placeholder_end = -1
...
if placeholder_start != -1:
    del new_lines[placeholder_start:placeholder_end+1]
...
# Add import statement after "from app.providers.user_model_settings import generate_post_text_for_user"
final_lines = []
